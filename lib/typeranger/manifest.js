...
JS.Packages(function() { with(this) {
    ...
    file('lib/typeranger/key_dispatcher.js')
      ...
      .requires('JS.Module', 'JS.Class', 'JS.Kernel', 'JS.Singleton', 'jQuery', 'key', 'TypeRanger.Element');
    ...
    file('lib/typeranger/base.js')
      ...
      .requires('JS.Module', 'JS.Class', 'JS.Kernel', 'JS.Singleton', 'jQuery', 'rangy', 'TypeRanger.Caret', 'TypeRanger.KeyDispatcher', 'TypeRanger.TextContainer');
